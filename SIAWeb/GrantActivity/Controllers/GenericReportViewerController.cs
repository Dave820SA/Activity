    ...
    public class GenericReportViewerController : Controller
    {
        ...
        public void ShowGenericRpt()
        {
            try
            {
                ...
                string strDailyID = System.Web.HttpContext.Current.Session["ActivityID"].ToString();     // Setting FromDate 
                ...
                if (isValid)
                {
                    ...
                    //rd.ParameterFields("@ActivityID");
                    rd.SetParameterValue("@ActivityID", strDailyID);
                    //if (!string.IsNullOrEmpty(strToDate))
                    //    rd.SetParameterValue("toDate", strFromDate);
                    rd.SetDatabaseLogon("sapdgis", "samdev");
